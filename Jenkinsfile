pipeline {
    ...
    stages {
        ...
        stage('Docker Image Scan') {
            steps {
                sh "trivy image --format table -o dimage.html sachidananda06/gitops:${params.DOCKER_TAG} "
            }
        }
            ...
            steps {
                script {
                    withCredentials([gitUsernamePassword(credentialsId: 'git-cred', gitToolName: 'Default')]) {
                       ...
                       #Clone the Git Repo
                       git clone https://github.com/sachi3050/Multi-Tier-BankApp-CD.git 
                       ...
                       sed -i "s|image: sachidananda06/gitops:.*|image: sachidananda06/gitops:${DOCKER_TAG}|" bankapp/bankapp-ds.yml '''
